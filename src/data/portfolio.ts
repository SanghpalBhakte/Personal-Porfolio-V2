...
export const SYSTEMS = [
  {
    ...
    problem: 'Customer inquiries were going cold due to delayed manual follow-ups in the inbox.',
    role: 'Full-stack bot & workflow design',
    description: 'WhatsApp bot + automated reminder system so leads don’t die in the inbox.',
    tags: ['AI Chatbot', 'n8n', 'WhatsApp API', 'Automation'],
    link: '#project-janai-tours',
  },
  {
    id: 'campus-os',
    title: 'Student Productivity & Personal Systems (CampusOS)',
    problem: 'Scattered student notes and task chaos across five different productivity apps.',
    role: 'System architecture & Notion/Todoist integration',
    ...
    tags: ['Notion', 'Todoist', 'Workflow'],
    link: '#project-student-os',
  },
  {
    id: 'travel-rag',
    title: 'Travel Agency Workflow Automation (RAG Pipeline)',
    problem: 'Staff wasting hours copy-pasting itinerary details and answering repetitive travel queries.',
    role: 'RAG pipeline setup & background automation',
  ...
  {
    id: 'esummit-gfx',
    title: 'E-Summit Brand & Graphic Design Showcase',
    problem: 'Inconsistent visual identity and fragmented graphics across social channels.',
    role: 'Brand strategy & GFX design',
    description: 'High-impact visual identity and social graphics showcase that unified the summit brand.',
...
export const PROJECTS = [
  {
    ...
    problem: 'Leads going cold due to manual inbox follow-up delays.',
    role: 'Full-stack bot & workflow design',
  ...
  },
  {
    ...
    category: 'AI & Automation' as const,
    problem: 'Cold leads missing scheduled follow-up touchpoints.',
    role: 'Workflow logic & notification design',
  ...
  },
  {
    ...
    problem: 'Task chaos and fragmented tracking across multiple student apps.',
    role: 'System architecture & Notion/Todoist integration',
    description: 'Student workflow layer that cuts app chaos and makes it clear what to do today instead of juggling five tools.',
    links: [],
  },
  {
    ...
    category: 'AI & Automation' as const,
    problem: 'Hours wasted on manual copy-pasting for package details and booking info.',
    role: 'RAG pipeline & background automation',
    description: 'Itinerary + info handled automatically so staff stop copy-pasting.',
    links: [],
  },
  {
    id: 'esummit-gfx', icon: '🎨',
    title: 'E-Summit Brand & Design Showcase', client: 'College E-Summit',
    category: 'Design' as const,
    problem: 'Inconsistent branding across social platforms.',
    role: 'Visual strategy & graphic design',
